...
new Airport { Id = 11, City = "Bangkok", Name = "Suvarnabhumi", IataCode = "BKK", Country = "Thailand" },
new Airport { Id = 12, City = "Hong Kong", Name = "Hong Kong Intl", IataCode = "HKG", Country = "China" },
new Airport { Id = 13, City = "Multan", Name = "Multan Intl", IataCode = "MUX", Country = "Pakistan" }
